...
class UserBuddyServiceTest {
    ...
    public void itShouldAddAUserBuddy() {
        ...
        assertNotNull(underTest.getAllUserBuddies());
        assertNotNull(underTest.getAllUserBuddiesByUserAccount(userAccount));
        assertNotNull(underTest.getAllBuddiesByUserAccount(userAccount));
    }
